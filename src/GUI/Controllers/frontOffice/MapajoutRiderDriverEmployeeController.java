...
public class MapajoutRiderDriverEmployeeController implements Initializable, MapComponentInitializedListener, DirectionsServiceCallback {
    ...
    private void go(ActionEvent event) throws IOException {
        if (fromTextField.getText().equals("") & toTextField.getText().equals("")) {
            ...
            AnchorPane pane = FXMLLoader.load(getClass().getResource("/GUI/Interfaces/AjouterRideEmployee.fxml"));
            ap.getChildren().setAll(pane);
        }
    }
