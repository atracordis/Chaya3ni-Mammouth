...
public class MapajoutRideDriverController implements Initializable, MapComponentInitializedListener, DirectionsServiceCallback {
    ...
    private void go(ActionEvent event) throws IOException {
        ...
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/GUI/Interfaces/AjouteRideDriver.fxml"));
        ap.getChildren().setAll(pane);
    }
    }
