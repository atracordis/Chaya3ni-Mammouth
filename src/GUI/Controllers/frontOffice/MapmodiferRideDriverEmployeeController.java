...
public class MapmodiferRideDriverEmployeeController implements Initializable, MapComponentInitializedListener, DirectionsServiceCallback {
           ...
           for(Node node : box.getChildren()){
            if(node.getId()!=null){
                node.addEventHandler(MouseEvent.MOUSE_CLICKED, (e) ->{
                    ...
                    if(node.getId().equals("/GUI/Interfaces/affichetrajet")){
    ...
    private void go(ActionEvent event) throws IOException {
       if (fromTextField.getText().equals("") & toTextField.getText().equals("")) {
        ...
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/GUI/Interfaces/ModifiertrajetEmployee.fxml"));
        ap.getChildren().setAll(pane);
    }
    }
