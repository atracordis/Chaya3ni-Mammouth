 ...
 * @author Admin
 */
public class AdminUserProfileController extends AnchorPane {
    ...
    void initialize() throws MalformedURLException {
        ...
        dateBirth.setText(currentUser.getDateBirth());
            ...
            phone.setText(currentUser.getEmail());
    ...
    public void processDeleteUser(ActionEvent event) {
        if (application == null) {
            return;
        }
                        PreferencesService ps = new PreferencesService();
                        UserService us = new UserService();
                        us.deleteUser(ps.selectPreferencesId(User.getSelectedId()));
