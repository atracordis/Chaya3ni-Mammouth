 ...
 * @author user
 */
public class StatsMenuController extends AnchorPane {
    ...
    private void processComplaintsButton(ActionEvent event) throws IOException {
        //tunisiashopping.Tunisiashopping.getInstance().changescene(new Scene(FXMLLoader.load(getClass().getResource("/GUI/reclamation.fxml"))));
    }

    @FXML
    private void processRideButton(ActionEvent event) throws IOException {
        application.gotoRideDriversstats();
